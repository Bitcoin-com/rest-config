...
cd $GOPATH/src/blockbook && exec ./blockbook -sync -blockchaincfg=/blockchain_cfg.json -internal=:9030 -public=:9130 -certfile=server/testcert -logtostderr